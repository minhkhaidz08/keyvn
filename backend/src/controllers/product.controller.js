...
const LIST_COLS =
  'id, name, slug, description, short_description, price, seller_price, original_price, category, category_id, type, image_url, badge, is_active, is_featured, is_hot, is_sale, stock_override, discount, created_at, product_variants(id, name, price, seller_price, sort_order, in_stock)';
