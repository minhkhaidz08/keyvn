...
const updateSettings = asyncHandler(async (req, res) => {
  const allowed = ['logo_url', 'banner_url', 'shop_name', 'slogan', 'facebook', 'discord', 'telegram', 'zalo', 'contact_cards', 'email', 'phone', 'notifications_enabled', 'main_color', 'background_color', 'announcement', 'address', 'terms', 'privacy_policy', 'payment_guide'];
