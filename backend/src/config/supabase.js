...
const supabaseUrl = effective(process.env.SUPABASE_URL, 'https://uxqppmvefuxfowiogbxy.supabase.co');
...
if (supabaseServiceKey === 'no-key') {
  console.warn(
    '[KeyHub] Supabase credentials not configured. Fill SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY in backend/.env - the API will not work.'
  );
}
