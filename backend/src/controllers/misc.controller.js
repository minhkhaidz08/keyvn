...
const PUBLIC_SETTINGS = ['logo_url', 'banner_url', 'shop_name', 'slogan', 'facebook', 'discord', 'telegram', 'zalo', 'contact_cards', 'email', 'notifications_enabled', 'main_color', 'background_color', 'announcement'];
