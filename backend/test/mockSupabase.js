...
const SCHEMA = {
  ...
  products: ['id', 'name', 'slug', 'description', 'short_description', 'price', 'seller_price', 'original_price', 'image_url', 'category', 'category_id', 'type', 'badge', 'discount', 'is_active', 'is_featured', 'is_hot', 'is_sale', 'stock_override', 'sort_order', 'download_url', 'video_url', 'created_at', 'updated_at'],
  ...
  orders: ['id', 'order_code', 'group_code', 'user_id', 'product_id', 'product_name', 'variant_id', 'variant_name', 'key_id', 'key_value', 'price', 'discount_amount', 'total', 'status', 'payment_method', 'download_url', 'video_url', 'created_at'],
