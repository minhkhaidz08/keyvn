...
const PUBLIC_SETTINGS = ['logo_url', 'banner_url', 'favicon_url', 'og_image_url', 'shop_name', 'slogan', 'facebook', 'discord', 'telegram', 'zalo', 'contact_cards', 'email', 'notifications_enabled', 'main_color', 'background_color', 'announcement', 'maintenance_deposit_card', 'maintenance_deposit_bank', 'terms', 'privacy_policy', 'payment_guide', 'guide_cards', 'testimonials', 'videos'];
